...
@Component({
  selector: 'app-curso-modalidad-sep',
  templateUrl: './curso-modalidad-sep.component.html',
    styles: `
.ui.dimmer {
  top: 0;
  left: 0;
...
export class CursoModalidadSepComponent implements OnInit, OnChanges {
  ...
  private prepareFormData(currentCourse: any, fileUrl: string = ''): FormData {
    ...
    formData.append("tipo_curso_id", "5");
